...
def test_icon_path_absolute():
    ...
    from ask_human.dialogs import PACKAGE_ASSETS_DIR, GUIDialogHandler
...
def test_packaged_icons_exist():
    ...
    from ask_human.dialogs import PACKAGE_ASSETS_DIR
    ...
    telegram_assets_dir = PACKAGE_ASSETS_DIR / "telegram"
    assert (telegram_assets_dir / "icon-color-round.png").is_file()
    assert (telegram_assets_dir / "icon-color-round-alt.png").is_file()
